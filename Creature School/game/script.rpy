...
label to_do_wednesday:
    ...
    menu:
        ...
        "Buy dinner from the cafeteria. {i}This action will cost $10{/i}":
            ...
            $money -= 10
            jump evening_activity_wednesday
...
label to_do_thursday:
    ...
    menu:
        ...
        "Buy dinner from the cafeteria. {i}This action will cost $10{/i}":
            ...
            $money -= 10
            jump evening_activity_thursday
